...
public class Codeview {
     ...
     * @return
     * @see com.jk.codeview.Settings.WithStyle
     */
    ...
    public <T extends WebView> void into(T webview, String baseUrl) {
        ...
        webview.loadDataWithBaseURL(baseUrl, htmlDocument, "text/html", "utf-8", "");
